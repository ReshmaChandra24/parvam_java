...
class Employee {
	...
	@Override
	public int hashCode() {
		return Objects.hash(designation, email, id, location, name, phoneNumber, yearsOfExperience);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(designation, other.designation) && Objects.equals(email, other.email) && id == other.id
				&& Objects.equals(location, other.location) && Objects.equals(name, other.name)
				&& phoneNumber == other.phoneNumber && yearsOfExperience == other.yearsOfExperience;
	}
}
